...
Level.prototype.obstacleAt = function (pos, size) {
  ...
  // consider sides and top and bottom of the level as walls
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  var resetP = new Vector(10, 10);
    if (obstacle == "lava"){
      this.pos = new Vector(5,12);
    }

  // floor is also obstacle -- only allow player jump if touch some obstacles
  if (obstacle) {
